...
const ar: Content = {
  ...
  metaDescription: `بسطيلة مغربية أصيلة (Pastilla) معمولة في الدار بالقنيطرة: بالدجاج أو بالسمك، من 4 إلى 12 شخص، ابتداءً من ${MIN_PRICE} درهم. اطلب في نقرة واحدة عبر واتساب.`,
  keywords: [
    "بسطيلة القنيطرة",
    "بسطيلة مغربية",
    "بسطيلة بالدجاج",
    ...
    "pastilla Kénitra",
    "pastilla مغربية",
    "وصفة بسطيلة القنيطرة",
  ],
  ogAlt: "بسطيلة مغربية (Pastilla) معمولة في الدار بالقنيطرة — بالدجاج وبالسمك",
  skipToContent: "انتقل إلى المحتوى",
  nav: [
    { href: "#pastillas", label: "بسطيلاتنا" },
  ...
  hero: {
    ...
    lede: "ورقة رقيقة ومقرمشة، حشوة سخية، وطعم البسطيلة (Pastilla) التي تعرفها. بالدجاج أو بالسمك، من 4 إلى 12 شخص.",
  ...
  products: {
    ...
    items: {
      poulet: {
        ...
        alt: "بسطيلة بالدجاج (Pastilla) معمولة في الدار: أوراق ذهبية، سكر ناعم، لوز مقشور وبريوات بالسمسم",
  ...
  faq: {
    ...
    items: [
      {
        q: "البسطيلة و«Pastilla»، هل هما نفس الشيء؟",
        a: "نعم، تمامًا. «بسطيلة» و«Pastilla» (وأحيانًا «Bstilla») أسماء مختلفة لنفس الطبق المغربي — الكتابة تتغيّر حسب اللغة، لكن الوصفة والحشوة هي نفسها. هنا تجدها بالدجاج أو بالسمك، معمولة في الدار.",
      },
      {
        q: "كيف أطلب؟",
...
const fr: Content = {
  brand: BRAND_LATIN,
  brandSub: "Kénitra",
  metaTitle: "pastilla Kénitra | Pastilla marocaine faite maison — Commande WhatsApp",
  metaDescription: `pastilla (pastilla) marocaine faite maison à Kénitra : au poulet ou au poisson, de 4 à 12 personnes, à partir de ${MIN_PRICE} dh. Commande en un clic sur WhatsApp.`,
  keywords: [
    "pastilla Kénitra",
    "pastilla Kénitra",
    "pastilla marocaine",
    "pastilla marocaine",
    "pastilla maison",
    "recette pastilla Kénitra",
    "pastilla poulet",
    "pastilla poulet",
    "pastilla poisson",
    "pastilla poisson",
    "commander pastilla Kénitra",
    "pastilla mariage Kénitra",
    "pastilla Ramadan",
    "livraison pastilla Kénitra",
  ],
  ogAlt: "pastilla (pastilla) marocaine faite maison à Kénitra — poulet et poisson",
  skipToContent: "Aller au contenu",
  nav: [
    { href: "#pastillas", label: "Nos pastillas" },
  ...
  hero: {
    eyebrow: "pastillas authentiques · Kénitra",
    titleLead: "La vraie pastilla marocaine,",
    titleAccent: "faite maison à Kénitra.",
    lede: "Une feuille fine et croustillante, une garniture généreuse, le goût de la pastilla (pastilla) que vous connaissez. Au poulet ou au poisson, de 4 à 12 personnes.",
    fromPrice: "à partir de",
    badgeLabel: "À partir de",
    badgeNote: "pastilla 4 personnes",
  ...
  products: {
    ...
    title: "Nos pastillas",
    intro: "Chaque pastilla est montée et dorée à la commande. Choisissez la recette et le nombre de convives : le prix s'affiche, et votre message WhatsApp est déjà prêt.",
    ...
    items: {
      poulet: {
        ...
        tag: "La classique",
        description:
          "La pastilla que tout le monde attend à table : des feuilles fines et croustillantes, une garniture au poulet préparée à la maison, et cette touche sucrée-salée qui fait la vraie pastilla marocaine.",
        alt: "pastilla (pastilla) au poulet faite maison : feuilles dorées, sucre glace, amandes effilées et briouates au sésame",
        altDetail: "Gros plan sur le cœur de la pastilla au poulet : briouates au sésame et amandes effilées",
      },
      poisson: {
        ...
        alt: "pastilla au poisson et fruits de mer sur son plateau, garnie de crevettes et de rondelles de citron",
        altDetail: "Gros plan sur la garniture de la pastilla au poisson : crevettes, fromage et citron",
      },
    },
  },
  preview: {
  ...
  prices: {
    ...
    colPoisson: "Poisson",
    people: "pers.",
    caption: "Tarifs des pastillas pastilla Kénitra en dirhams, selon la recette et le nombre de personnes",
    note: "Prix en dirhams (MAD). pastillas préparées sur commande — pensez à réserver à l'avance pour les grandes occasions.",
    cellAria: (price, name, servings) =>
      `${price} dh — commander la ${name.toLowerCase()} pour ${servings} personnes sur WhatsApp`,
  },
  detailBand: { label: "Gros plans sur la pastilla au poulet et la pastilla au poisson" },
  occasions: {
    eyebrow: "Pour toutes vos tablées",
    title: "La pastilla des grandes occasions",
    text: "Une pastilla, c'est le plat qu'on pose au centre de la table et qui fait taire les conversations. Nos formats vont jusqu'à 12 personnes — et rien n'empêche d'en commander plusieurs.",
    imageAlt: "pastilla au poisson dressée sur un grand plateau, prête pour la table",
    insetAlt: "Gros plan sur le cœur de la pastilla au poulet, amandes et briouates",
    items: [
      { title: "Repas de famille", text: "Le plat qui met tout le monde d'accord, du plus petit au plus grand." },
      { title: "Invités à la maison", text: "Vous recevez ? Une pastilla dorée au centre de la table, et le ton est donné." },
      { title: "Fêtes & mariages", text: "Pour les grandes tablées, jusqu'à 12 personnes par pastilla." },
      { title: "Ramadan", text: "Une pastilla généreuse à partager au moment de rompre le jeûne." },
      { title: "Réunions & bureau", text: "Un déjeuner qui change de l'ordinaire, prêt à partager." },
      { title: "Occasions spéciales", text: "Anniversaires, bonnes nouvelles : ça se fête avec une vraie pastilla." },
    ],
  },
  how: {
    ...
    steps: [
      { title: "Choisissez votre pastilla", text: "Poulet ou poisson, et le nombre de personnes, de 4 à 12." },
      ...
      { title: "Dégustez", text: "Votre pastilla est préparée à la commande et vous arrive dorée, prête à servir." },
    ],
  },
  faq: {
    ...
    items: [
      {
        q: "pastilla ou pastilla, est-ce la même chose ?",
        a: "Oui, exactement. « pastilla » et « pastilla » (on trouve aussi « bstilla ») désignent le même plat marocain — seule l'orthographe change selon la langue, la recette et la garniture restent les mêmes. Ici, vous la trouvez au poulet ou au poisson, faite maison.",
      },
      {
        q: "Comment passer commande ?",
        a: "Tout se fait sur WhatsApp. Choisissez votre pastilla (poulet ou poisson) et le nombre de personnes, puis cliquez sur un bouton « Commander sur WhatsApp » : le message est déjà pré-rempli. Il ne reste qu'à l'envoyer et à convenir des détails avec nous.",
      },
      {
        q: "Quels sont les prix ?",
        a: "La pastilla au poulet va de 250 dh (4 personnes) à 700 dh (12 personnes). La pastilla au poisson va de 350 dh (4 personnes) à 1000 dh (12 personnes). Tous les tarifs sont affichés sur cette page, sans supplément caché.",
      },
      {
        q: "Quelle taille choisir ?",
        a: "Les pastillas sont proposées pour 4, 6, 8, 10 ou 12 personnes. En cas d'hésitation entre deux formats, prenez le plus grand : une pastilla se partage toujours très bien. Écrivez-nous sur WhatsApp, nous vous aidons à choisir.",
      },
      {
        q: "Est-ce vraiment fait maison ?",
        a: "Oui. Chaque pastilla est préparée à la maison, à la commande, avec des ingrédients naturels. Rien n'est produit à l'avance ni industriellement.",
      },
      {
      ...
      },
      {
        ...
        a: "Les pastillas étant préparées sur commande, il vaut mieux s'y prendre à l'avance, surtout pour les week-ends, les fêtes et les grandes tablées. Envoyez-nous un message sur WhatsApp : nous vous confirmons le délai selon la date souhaitée.",
      },
      {
      ...
      },
      {
        ...
        a: "Bien sûr. Pour plusieurs pastillas ou une grande réception, écrivez-nous sur WhatsApp en précisant la date et le nombre d'invités : nous organisons la commande avec vous.",
      },
    ],
  },
  finalCta: {
    title: "Envie d'une vraie pastilla marocaine ?",
  ...
  footer: {
    about: "pastillas marocaines faites maison à Kénitra. Poulet ou poisson, de 4 à 12 personnes, préparées à la commande.",
    siteHeading: "Le site",
  ...
  sticky: { title: "pastilla faite maison", note: `Dès ${MIN_PRICE} dh · Kénitra` },
  waMessages: {
    generic: "Bonjour 👋 Je souhaite commander une pastilla. Pouvez-vous m'indiquer les disponibilités ?",
    order: (name, servings, price) =>
      `Bonjour 👋 Je souhaite commander une ${name.toLowerCase()} pour ${servings} personnes (${price} dh). Est-ce disponible ?`,
  },
};
